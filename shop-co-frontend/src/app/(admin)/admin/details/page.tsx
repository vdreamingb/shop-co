...
export default function AdminDetailsPage() {
    const query = useQuery({queryKey: ['details'], queryFn: async () => await detailsService.getAll()})
    ...
    return (
        <div>
            ...
            <DataDisplay data={Array.isArray(query.data)? query.data : []} headers={DetailsTableHaders} />
            <CustomModal setIsOpen={setIsOpen} isOpen={isOpen}  title="Create new product details" content={<CreateDetailsForm />} />
        </div>
    )
}