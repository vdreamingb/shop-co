...
export class ProductsService {
    ...
    async create(data: any, file: Multer.File){
        const imageUrl = await this.r2Service.uploadImg(file.buffer, file.originalname)
    ...
    async modifyProduct(id: number, name: string, price: number, brand: string | undefined, description:string | undefined){
